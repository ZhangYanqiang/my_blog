...
<div class="add-cate-body">
    <div class="info-nav-top">
        <a href="{{url('admin/info')}}">首页</a> &raquo;修改文章
    </div>
        ...
        <div class="add-cate-box">
            <table class="add-cate-table">
                ...
                <tr>
                    <th></th>
                    <td>
                        <img src="/{{$field->art_thumb}}" alt="" id="art_thumb_img" style="max-width: 350px; max-height: 200px;">
                     </td>
                </tr>
                <tr>
                    <th>关键词</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <script id="editor" name="art_content" type="text/plain" style="width:1024px; height:500px;" value="">{!! $field->art_content !!}</script>
                        <script type="text/javascript">
